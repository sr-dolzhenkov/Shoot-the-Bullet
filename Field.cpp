...
//ищем свободный ряд(пустые с значениями -1, -1), кода находи записываем туда соотвествющие координаты снаряда
...
//в нижний ряд записываем верхний(двигаемся снизу вверх), потом создаем строку на 1 ряду, а также проверяем не проирал ли игрок
...
//зануляем строку соотвествующию строку, также увиличиваем счётчик очков на 1
...
//полёт осуществляется путём уменьшения координаты y, а также проверяем не было ли столкновения, иначе удаляем снаряд и добавляем блок в ряд, и проверяем не полный ли ряд, очищаем его
